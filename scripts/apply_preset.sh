...
# Updated to point directly to the Lua file generated by DMS
CONFIG_FILE="$HOME/.config/hypr/dms/colors.lua"
BRIGHTNESS=2
...
get_theme_color() {
    ...
    # Updated regex to match 'active_border = "rgb(xxxxxx)"' from the Lua table
    HEX_COLOR="$(
