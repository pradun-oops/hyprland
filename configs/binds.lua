...
hl.bind(
	"SUPER + ALT + C",
	hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/qs_dialog.sh control-center toggle")
)
hl.bind("SUPER + SHIFT + C", hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/qs_dialog.sh calendar open"))
hl.bind(
	"SUPER + N",
	hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/qs_dialog.sh notification-history open")
)
...
hl.bind(
	"SUPER + SHIFT+ CTRL + C",
	hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/qs_dialog.sh calculator open")
)
