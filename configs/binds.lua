...
-- ============================================================================
-- ⌨️ KEYBINDINGS & SHORTCUTS CONFIGURATION
-- ============================================================================
-- Defines system hotkeys, window management controls, hardware shortcuts,
-- application launchers, and Quickshell dialog bindings.
-- ============================================================================
...
-- Quickshell Dialogs & Interactive Overlays
...
hl.bind("SUPER + slash", run_script("qs_dialog.sh keybinds open")) -- Remapped from SUPER+K to avoid Vim conflict
...
-- Laptop Screen & External Monitor Brightness (ddcutil)
...
hl.bind("SUPER + O", hl.dsp.exec_cmd("VirtualBox Manager")) -- Quick launch for VM environment management
...
-- Window Movement (Vim Directional)
hl.bind("SUPER + SHIFT + H", hl.dsp.window.move({ direction = "l" }))
hl.bind("SUPER + SHIFT + L", hl.dsp.window.move({ direction = "r" }))
hl.bind("SUPER + SHIFT + K", hl.dsp.window.move({ direction = "u" }))
hl.bind("SUPER + SHIFT + J", hl.dsp.window.move({ direction = "d" }))

-- Window Resizing & Mouse Dragging
...
-- Dual Monitor Cross-Screen Focus & Migration
...
-- Workspace Switching & Special Layers
...
-- Indexed Workspaces (1–10) & Layout Presets
for i = 1, 9 do
