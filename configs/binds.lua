...
-- Shell Controls & Lenovo Specifics
...
hl.bind("SUPER + ALT + K",        hl.dsp.exec_cmd("quickshell -c " .. home .. "/.config/hypr/quickshell/backlight/"))
...
-- Brightness (Laptop Panel vs Acer Monitor via ddcutil)
...
-- Dual Monitor Crossing (Laptop <-> Acer EK251Q)
