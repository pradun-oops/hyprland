...
apply_blur({
    ...
    "qs-calendar", "qs-network-center", "qs-control-center", "qs-notification-center", "qs-bluetooth-center", "qs-sysmon", "qs-weather", "qs-config", "qs-wallselect","qs-drawer", "qs-calculator","qs-filemanager","qs-clipboard"
}, 0.01)
